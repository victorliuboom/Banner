...
public class MyMainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener, ViewPager.OnPageChangeListener, OnItemClickListener {
...
//        convenientBanner.setCanLoop(!convenientBanner.isCanLoop());
    ...
    public void onItemClick(int position) {
        if(position==0){
            Log.e("bbb","bb");
            startActivity(new Intent(MyMainActivity.this,DemeActivity.class));
        }
